...
class signUP : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCallBacks = object :PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                timer()
                Toast.makeText(this@signUP,"Varification code sent",Toast.LENGTH_LONG).show()
    ...
    private fun VerifyingPhone(){
        ...
        if (phoneNumber.length == 11){
            ...
            db.collection(phone).document("Profile").get().addOnSuccessListener {
                if (it.exists()){
                    exception.visibility = View.VISIBLE
                    exception.setText("User Alredy exsist")
                    progressDialog.hide()
                }else{
            ...
            verfiyNumber.error = "Invalid Number"
        }
    }
    ...
    private fun signInWithPhoneAuthCredentia(credential: PhoneAuthCredential) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnSuccessListener {
            val intent = Intent(this@signUP,regesterNow::class.java)
    ...
    fun init(){
        verfiyNumber = findViewById(R.id.verifyNumber)
        nextBtn = findViewById(R.id.nextBtn)
        exception = findViewById(R.id.excetion)
        enterOTP = findViewById(R.id.enterOTP)
        verifyBtn = findViewById(R.id.verifyBtn)
        verifyphone  = findViewById(R.id.verfiyphone)
        phoneActivity = findViewById(R.id.phoneActivity)
        otpActivity = findViewById(R.id.otpActivity)
